  ...
  return (
    <main className="flex min-h-svh flex-1">
      ...
      <div className="bg-secondary relative hidden flex-1 items-center justify-center overflow-hidden p-10 md:flex">
        {/* espaço reservado para foto real da loja/produtos: solte um arquivo
            em public/login-cookies.jpg e troque o painel abaixo por
            um <img src="/login-cookies.jpg" className="..." /> */}
        ...
        <div className="max-w-xs text-center">
          <p
            className={`${caveat.className} text-primary text-4xl leading-tight`}
          >
            Cookies que faz dia mais doce.
          </p>
          <Heart className="fill-primary text-primary mx-auto mt-3 size-6" />
        </div>
      </div>
    </main>
  )
